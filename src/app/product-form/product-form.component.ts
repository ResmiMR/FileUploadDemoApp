...
export class ProductFormComponent implements OnInit {
  myForm ;
  buttonString:string;
  constructor(public fb:FormBuilder,private ps:ProductsService,  public dialogRef: MatDialogRef<ProductFormComponent>,@Inject(MAT_DIALOG_DATA) public data:any) {
   console.log(data)
   if(data==null){
